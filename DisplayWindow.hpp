...
private:
	...
	std::atomic_bool threadExit; ///< Set to true when the video updating thread should exit
	std::unique_ptr<std::thread> videoUpdateThread; ///< Reads from the video file and updates the displayed frame
